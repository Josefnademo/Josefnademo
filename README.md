...
# 💻 Tech Stack:
[![My Skills](https://skillicons.dev/icons?i=vue,docker,nodejs,npm,express,js,html,css,ts,adonis,cypress,jest,electron,py,cs,dotnet,mysql,mongodb,sqlite,redis,sequelize,nginx,azure,tensorflow,powershell,bash,git,figma)](https://skillicons.dev)
# 📊 GitHub Stats:
<div align="center"> 
